...
class TestTheoryHead(TestCase):
    def test_transform(self):
        self.assertEqual(theory_atoms("&tel { >a }."), ['(1>a)'])
        self.assertEqual(theory_atoms("&tel { > >a }."), ['(1>(1>a))'])
        self.assertEqual(theory_atoms("&tel { >>a }."), ['(>*((~__final)|a))'])
        self.assertEqual(theory_atoms("&tel { a>?b }."), ['(a>?b)'])
        self.assertEqual(theory_atoms("&tel { a>*b }."), ['(a>*b)'])
        self.assertEqual(theory_atoms("&tel { -a }."), ['-a'])
        self.assertEqual(theory_atoms("&tel { ~a }."), ['(~a)'])
        self.assertEqual(theory_atoms("&tel { a&b }."), ['(a&b)'])
        self.assertEqual(theory_atoms("&tel { a|b }."), ['(a|b)'])
        self.assertEqual(theory_atoms("&tel { &final }."), ['(~(~__final))'])
